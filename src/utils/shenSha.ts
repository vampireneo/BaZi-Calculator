...
/**
 * 歲德查詢表
 * 以年干查詢（返回八卦方位，需要配合其他系統使用）
 * TODO: 待實現八卦方位與地支的對應邏輯
 */
...
export function calculateBaZiShenSha(
  ...
  Object.entries(branchCounts).forEach(([, data]) => {
    if (data.count >= 2) {
